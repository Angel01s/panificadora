                                ...
                                <tr>
                                    <td>{{ $user->name }}</td>
                                            ...
                                            @if($user->foto == "")
                                                ...
                                                <td><img src="{{ url('storage/defecto.png')}}" width="50px" alt=""></td>

                                            @else

                                                <td><img src="{{ url('storage/'.$user->foto)}}" width="50px" alt=""></td>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="{{ url('Editar-Usuario/'.$user->id) }}">
                                            <button class="btn btn-success" data-toggle="modal" data-target="#EditarUsuario"><i class="fa fa-pencil"></i></button>
                                        </a> --}}
